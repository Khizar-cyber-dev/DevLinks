...
export default function CreateProjectPage() {
  ...
  useEffect(() => {
    if (projectId) {
      // Fetch the project data from API if editing
  ...
  const onSubmit = async (data: ProjectFormValues) => {
    try {
      ...
      console.log('Project successfully processed:', responseData);
      ...
      alert(error instanceof Error ? error.message : 'Failed to process project. Please try again.');
    }
  };
